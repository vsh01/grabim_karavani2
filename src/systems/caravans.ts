 ...
 * Трёх на четыре квадратных километра было слишком мало: дорога пустовала, и
 * главное занятие игры приходилось выискивать.
 */
const MAX_ACTIVE = 5;
/** Разброс паузы между выходами корованов, секунды. */
const SPAWN_INTERVAL: [number, number] = [30, 60];
